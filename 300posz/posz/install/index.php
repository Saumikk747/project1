					...
					<div class="tab-pane fade in active" id="Config">
						...
						<form id="install_form" method="post" action="?step=2">
							<?php if($_POST){
								...
								$settings = mysqli_query($con,"INSERT INTO settings (`id`, `companyname`, `phone`, `currency`, `receiptfooter`, `theme`, `tax`, `timezone`, `language`, `keyboard`, `stripe`) VALUES (1, '$company', '$phone', '$currency', 'Thank you for your business', 'Light', '$tax', '$timezone', 'english', '1', '0');");
...
<div class="tab-content">
            ...
            <div class="bg-warning"><i class='icon-warning-sign'></i> Please don't forget to change username and password.</div>
				...
				<?php }else{ ?>
					<div class="tab-content">
						<h1><i class="fa fa-lock" aria-hidden="true" style="margin-right:10px"></i>Please Delete old databse and files from your server, try to install again!</h1>
				<?php } ?>
         </div>
       </div>
