                                    ...
                                    <td><?php echo $new->title?></td>
									 <td class="col-md-3">
                                        <div class="btn-group">
										 ...
										 <a class="btn btn-danger" style="margin-left:2px;" href="<?php echo site_url('admin/employees/delete_document/'.$new->id); ?>" onclick="return areyousure()"><i class="fa fa-trash"></i> <?php echo lang('delete');?></a>
										 <?php } ?>
										 </div>
                                    </td>
                                </tr>
