...
$masters = array("location","tax","case_category","court_category","act","court","case_stage","payment_mode");
	...
	//echo '<pre>';print_r($active_actions);exit;
?>
  ...
  <body class="hold-transition skin-black sidebar-mini fixed">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <?php }else{ ?>
            <span class="logo-lg"><img src="<?php echo base_url('assets/uploads/images/'.@$setting->image); ?>" width="150" height="50" /></span>
        <?php }?>
      </a>
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <?php if(!empty($admin['image'])){ ?>
                        <img src="<?php echo base_url('assets/uploads/images/'.$admin['image']);?>"class="user-image" />    
                    <?php }else{ ?>	
                        <img src="<?php echo base_url('assets/uploads/images/avatar5.png');?>"class="user-image" />    
                    <?php } ?>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <?php if(!empty($admin['image'])){ ?>
                        <img src="<?php echo base_url('assets/uploads/images/'.$admin['image']);?>"class="img-circle" />    
                    <?php }else{ ?>	
                        <img src="<?php echo base_url('assets/uploads/images/avatar5.png');?>"class="img-circle" />    
                    <?php } ?>
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <?php if(!empty($admin['image'])){ ?>
                <img src="<?php echo base_url('assets/uploads/images/'.$admin['image']);?>"class="img-circle img-responsive" />    
              <?php }else{ ?>	
                <img src="<?php echo base_url('assets/uploads/images/avatar5.png');?>"class="img-circle img-responsive" />    
              <?php } ?>    
            </div>
