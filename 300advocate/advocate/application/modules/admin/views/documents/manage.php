							...
							?>
                                <tr class="gc_row">
                                    ...
                                    <td><?php echo $new->title?></td>
									 <td class="col-md-3">
                                        <div class="btn-group">
                                         <a class="btn btn-default" download style="margin-left:2px;" href="<?php echo base_url('uploads/documents/'.$new->file_name); ?>" ><i class="fa fa-download"></i> <?php echo lang('download');?></a>
