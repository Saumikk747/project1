    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
				<?php echo form_open_multipart('admin/notice/edit/'.$id); ?>
                    <div class="box-body">
                        <div class="box-body">
                        <div class="form-group">
                        	<div class="row">
                                <div class="col-md-4">
									...
									<input type="text" name="title" value="<?php echo $notice->title; ?>" class="form-control">
                                </div>
                            </div>
                        </div>
						 ...
						 <div class="form-group">
                        	<div class="row">
                                <div class="col-md-4">
									...
									<textarea name="description"class="form-control"><?php echo $notice->description; ?></textarea>
                                </div>
                            </div>
                        </div>
						 ...
						 <div class="form-group">
                        	<div class="row">
                                <div class="col-md-4">
									...
									<input type="text" name="date_time" value="<?php echo $notice->date_time; ?>" class="form-control datetimepicker" />
                                </div>
                            </div>
                        </div>
