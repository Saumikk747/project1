...
<section class="content">
            ...
            <div class="col-xs-12">
				...
				<?php if(check_user_role(47)==1){?>	
                    <a class="btn btn-default" href="<?php echo site_url('admin/departments/add/'); ?>"><i class="fa fa-plus"></i> <?php echo lang('add_new');?></a>
				<?php } ?>		
                </div>
            </div>    
        </div>	
          ...
          <div class="col-xs-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title"><?php echo lang('department');?></h3>                                    
                </div><!-- /.box-header -->
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        <thead>
                            <tr>
								...
								<th><?php echo lang('designations');?></th>
                        ...
                        <tbody>
                            <?php $i=1;foreach ($departments as $new){?>
                                <tr class="gc_row">
                                    <td><?php echo $i?></td>
