...
<link href="<?php echo base_url('assets/plugins/jquery.datetimepicker/jquery.datetimepicker.css')?>" rel="stylesheet" type="text/css" />
  ...
  <!-- Ion Slider -->
<link href="<?php echo base_url()?>assets/plugins/ionslider/ion.rangeSlider.css" rel="stylesheet" type="text/css" />
<!-- ion slider Nice -->
<link href="<?php echo base_url()?>assets/plugins/ionslider/ion.rangeSlider.skinNice.css" rel="stylesheet" type="text/css" />
<link href="<?php echo base_url()?>assets/plugins/bootstrap-slider/slider.css" rel="stylesheet" type="text/css" />
...
<script src="<?php echo base_url('assets/plugins/chosen/chosen.jquery.min.js')?>" type="text/javascript"></script>
  <!-- Ion Slider -->
<script src="<?php echo base_url()?>/assets/plugins/ionslider/ion.rangeSlider.min.js" type="text/javascript"></script>

<!-- Bootstrap slider -->
<script src="<?php echo base_url()?>/assets/plugins/bootstrap-slider/bootstrap-slider.js" type="text/javascript"></script>
