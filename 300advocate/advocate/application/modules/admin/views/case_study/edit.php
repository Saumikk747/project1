    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
				<?php echo form_open_multipart('admin/case_study/edit/'.$id); ?>
                    <div class="box-body">
                       <div class="form-group">
                        	<div class="row">
								...
								<div class="col-md-4">
									<input type="text" name="title" value="<?php echo $case_study->title?>" class="form-control">
                                </div>
                            </div>
                        </div>
                      	<div class="form-group">
								...
								<div class="col-md-4">
                                    <select name="case_category_id[]" class="chzn form-control" multiple="multiple" data-placeholder="Select Case Categories" >
										<?php foreach($case_categories as $new) {
											$sel = "";
											$sel = (in_array($new->id,json_decode($case_study->case_categories)))?'selected': '';
						...
						<div class="form-group">
                        	<div class="row">
								...
								<div class="col-md-8">
                                   <textarea name="notes" class="form-control redactor"><?php echo $case_study->notes?></textarea>
                                </div>
                            </div>
                        </div>
						...
						<div class="form-group">
                        	<div class="row">
								...
								<div class="col-md-8">
                                   <textarea name="result" class="form-control redactor"><?php echo $case_study->result?></textarea>
                                </div>
                            </div>
                        </div>
